...
main = do
  ...
  Just explosao <- loadJuicy (path ++ "Explosion.png")
  Just waterMedium <- loadJuicy (path ++ "waterMedium.png")
  Just waterDeep <- loadJuicy (path ++ "waterDeep.png")
  Just waterDeeper <- loadJuicy (path ++ "waterDeeper.png")
  ...
  Just backgroundMorningBorrado <- loadJuicy (path ++ "BackgroundMorningBorrado.png")
  ...
  Just selectedOutline <- loadJuicy (path ++ "border.png") 

  Just selected <- loadJuicy (path ++ "Selected.png") 
  Just selectedRed <- loadJuicy (path ++ "SelectedRed.png") 
  

  Just flagB <- loadJuicy (path ++ "flagB.png") 
  Just flagR <- loadJuicy (path ++ "flagR.png") 

  Just burnCounter <- loadJuicy (path ++ "burnCounter.png") 
...
-}
  ...
  let temanatal = [neve, water, stone, patoParadoNatal, morto, barril, bazuca, skyNatal, dinamite, mina, dirt, lava, healthPack, patoPulandoNatal, blank_sprite, ammoJetpack, ammoEscavadora, ammoBazuca, ammoMina, ammoDinamite, botao, botaoOn, botaoOff, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, space, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, dash, pl, pr, slash, dott_points, comma, exclamation, interrogation, arrombado, snowBall, leftArrow, rightArrow, patoBazucaVermelho, patoBazucaAzul, blank_sprite, blank_sprite, patoAzulPulandoNatal, patoVermelhoPulandoNatal, patoVermelhoParadoNatal, patoAzulParadoNatal, blank_sprite, blank_sprite, patoEscavadoraAzul, patoEscavadoraVermelho, patoCongelado, backgroundNatal, patoVermelhoJetpack, patoAzulJetpack, backgroundNatalBorrado, botaoOn2, botaoOff2, lvlAddSign, patoOutlineNatal, patoOutlineNatalPulando, sidebar, sidebarAzul, sidebarVermelho, mapSheet, patoPulandoNatalR, patoParadoNatalR, patoCongeladoR, patoOutlineNatalR, patoOutlineNatalPulandoR, patoVermelhoPulandoNatalR, patoVermelhoParadoNatalR, patoBazucaVermelhoR, patoEscavadoraVermelhoR, patoVermelhoJetpackR, patoBazucaAzulR, patoAzulPulandoNatalR, patoAzulParadoNatalR, patoEscavadoraAzulR, patoAzulJetpackR, jetpack, escavadora, redWins, blueWins, selectedOutline, patoCongeladoOutline, patoCongeladoOutlineR, gelo, waterMedium, waterDeep, waterDeeper, explosao, backgroundMorningNatalBorrado, selected, flagB, flagR, selectedRed, burnCounter, bot, sword, book, pencil, iconNatal, exit]
