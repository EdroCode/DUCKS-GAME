...
flatWorld = EstadoDLC
    { mapaEstadoDLC =
        ...
        ,[ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC]
        ,[ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC,ArDLC]
        ,[TerraDLC,AguaDLC,AguaDLC,TerraDLC,TerraDLC,TerraDLC,TerraDLC,Gelo,TerraDLC,TerraDLC,Lava,ArDLC,ArDLC,ArDLC]
    ...
    , objetosEstadoDLC =
        ...
        DisparoDLC {posicaoDisparoDLC = (0,0), direcaoDisparoDLC = Sul, tipoDisparoDLC = FlameTrower, tempoDisparoDLC = Just 5, donoDisparoDLC = 0}]
    , minhocasEstadoDLC =
        [MinhocaDLC {posicaoMinhocaDLC = Just (0,4), vidaMinhocaDLC = VivaDLC 100, jetpackMinhocaDLC = 100, escavadoraMinhocaDLC = 100, bazucaMinhocaDLC = 100, minaMinhocaDLC = 100, dinamiteMinhocaDLC = 100, flameMinhocaDLC = 20,burningCounter = 0, equipaMinhoca = Just Red, ultimaDirecaoHorizontal = Este}
        ,MinhocaDLC {posicaoMinhocaDLC = Just (0,7), vidaMinhocaDLC = VivaDLC 100, jetpackMinhocaDLC = 100, escavadoraMinhocaDLC = 100, bazucaMinhocaDLC = 100, minaMinhocaDLC = 100, dinamiteMinhocaDLC = 100, flameMinhocaDLC = 20,burningCounter = 0, equipaMinhoca = Just Blue, ultimaDirecaoHorizontal = Oeste}
        ,MinhocaDLC {posicaoMinhocaDLC = Just (5,7), vidaMinhocaDLC = VivaDLC 100, jetpackMinhocaDLC = 100, escavadoraMinhocaDLC = 100, bazucaMinhocaDLC = 100, minaMinhocaDLC = 100, dinamiteMinhocaDLC = 100, flameMinhocaDLC = 20,burningCounter = 0, equipaMinhoca = Just Blue, ultimaDirecaoHorizontal = Este}
