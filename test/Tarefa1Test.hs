...
bazuca1 = Disparo {posicaoDisparo = (0,14), direcaoDisparo = Este, tipoDisparo = Bazuca, tempoDisparo = Nothing, donoDisparo = 0}
bazuca2 = Disparo {posicaoDisparo = (2,3), direcaoDisparo = Sul, tipoDisparo = Bazuca, tempoDisparo = Just 45, donoDisparo = 0}
...
estado6 = Estado
    ...
    , objetosEstado =
        ...
        ,Disparo {posicaoDisparo = (2,0), direcaoDisparo = Sul, tipoDisparo = Dinamite, tempoDisparo = Nothing, donoDisparo = 0}
        ]
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (2,8), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,4), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
...
estado13 = Estado
    ...
    , objetosEstado =
        [Disparo {posicaoDisparo = (2,4), direcaoDisparo = Sul, tipoDisparo = Mina, tempoDisparo = Nothing, donoDisparo = 4}
        ]
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (2,3), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,4), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
...
estado38 = Estado
    ...
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (2,2), vidaMinhoca = Viva 145, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
...
estado41 = Estado
    ...
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (2,2), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1023, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (3,7), vidaMinhoca = Morta, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = (-23), minaMinhoca = 1, dinamiteMinhoca = 1}
        ]
    }
estado42 = Estado
    { mapaEstado = mapaValido
    , objetosEstado =
        [Disparo (2,2) Norte Mina Nothing 0
        ,Disparo (2,2) Norte Mina Nothing 0]
    , minhocasEstado =
...
estado44 = Estado
    { mapaEstado = mapaValido
    , objetosEstado =
        [Disparo (3,6) Norte Mina Nothing 0]
    , minhocasEstado =
        [Minhoca (Just (3,6)) (Viva 100) 1 1 1 1 1]
    }

estado45 = Estado
    { mapaEstado = mapaValido
    , objetosEstado =
        [Disparo (3,6) Norte Dinamite (Just 3) 0]
    , minhocasEstado =
        [Minhoca (Just (3,6)) (Viva 100) 1 1 1 1 1]
    }
...
estado46 = Estado
    { mapaEstado = mapaValido
    , objetosEstado =
        [Disparo (3,6) Norte Mina (Just 3) 0]
    , minhocasEstado =
        [Minhoca (Just (3,6)) (Viva 100) 1 1 1 1 1]
    }
...
estado47 = Estado
    ...
    , objetosEstado = []
    , minhocasEstado =
        [Minhoca Nothing (Viva 100) 1 1 1 1 1]
    }
...
estado49 = Estado
    ...
    , objetosEstado = []
    , minhocasEstado =
        [Minhoca (Just (3,6)) (Morta) 1 1 1 1 1]
    }
...
estado50 = Estado
    ...
    , objetosEstado = []
    , minhocasEstado =
        [Minhoca (Just (3,6)) (Viva (-10)) 1 1 1 1 1]
    }
...
estado52 = Estado
    ...
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (3,6), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,3), vidaMinhoca = Morta, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ]
    }
estado53 = Estado
    { mapaEstado =
    ...
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (3,6), vidaMinhoca = Viva 140, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,3), vidaMinhoca = Morta, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ]
    }
estado54 = Estado
    ...
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (3,6), vidaMinhoca = Viva (-40), jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,3), vidaMinhoca = Morta, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ]
    }
estado55 = Estado
    ...
    , objetosEstado =
        [Barril {posicaoBarril = (20,0), explodeBarril = False},Barril {posicaoBarril = (0,0), explodeBarril = False}]
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (0,0), vidaMinhoca = Viva (-40), jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,3), vidaMinhoca = Morta, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca (Just (2,2)) (Viva (-10)) 1 1 1 1 1]
    }
estado56 = Estado
  { mapaEstado = mapaValido
  , objetosEstado = []
...
estado57 = Estado
  { mapaEstado = mapaValido
  , objetosEstado = [Barril {posicaoBarril = (20,0), explodeBarril = False},Barril {posicaoBarril = (0,0), explodeBarril = False}]
  , minhocasEstado =
      []
  }
estado58 = Estado
    ...
    , objetosEstado =
        [Disparo {posicaoDisparo = (3,9), direcaoDisparo = Norte, tipoDisparo = Escavadora, tempoDisparo = Nothing, donoDisparo = 0}
        ]
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (3,6), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,3), vidaMinhoca = Morta, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
...
estado59 = Estado
    ...
    , objetosEstado =
        [Disparo {posicaoDisparo = (3,9), direcaoDisparo = Norte, tipoDisparo = Jetpack, tempoDisparo = Nothing, donoDisparo = 0}
        ]
    , minhocasEstado =
        [Minhoca {posicaoMinhoca = Just (3,6), vidaMinhoca = Viva 100, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
        ,Minhoca {posicaoMinhoca = Just (2,3), vidaMinhoca = Morta, jetpackMinhoca = 1, escavadoraMinhoca = 1, bazucaMinhoca = 1, minaMinhoca = 1, dinamiteMinhoca = 1}
