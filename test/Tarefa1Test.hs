...
estado1 = Estado{mapaEstado=mapaOk, objetosEstado=[disparoValido1, disparoValido2], minhocasEstado=[minhocaValida1, minhocaValida2]} -- estado totalmente válido
...
estado28 = Estado{mapaEstado=mapaOk, objetosEstado=[disparoValido4, barrilInvalido2], minhocasEstado=[minhocaValida2,minhocaValida1]} -- disparo perfura terreno + barril sobre minhoca
...
estado41 = Estado { mapaEstado = mapaOk, objetosEstado = [Disparo {posicaoDisparo = (4,4), direcaoDisparo = Oeste, tipoDisparo = Bazuca, tempoDisparo = Nothing, donoDisparo = 0}], minhocasEstado =[Minhoca {posicaoMinhoca = Just (3,0), vidaMinhoca = Morta, jetpackMinhoca = 100, escavadoraMinhoca = 200, bazucaMinhoca = 150, minaMinhoca = 3, dinamiteMinhoca = 1}]}
-- * -----------------------------------------
